...
<div>
  ...
  <v-toolbar dark color="primary">
    ...
    <v-checkbox
        v-model="checkbox"
        :label="`Keep it small?: ${checkbox.toString()}`"
    ></v-checkbox>
